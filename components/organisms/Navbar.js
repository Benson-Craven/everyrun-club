    ...
    >
        ...
        <div className='flex justify-between items-center h-16'>
          ...
          <div className='md:hidden'>
            <button
              ...
              className='inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-everyRunOrange hover:bg-purple-50 focus:outline-none'
            >
              {isOpen ? (
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className='px-2 pt-2 pb-3 space-y-1 sm:px-3'>
          <a
            href='#'
            className='block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-everyRunOrange hover:bg-purple-50'
          >
            Routes
          </a>
          <a
